...
const val ACTION_PARAMETER_SOURCE_ID = "source"
const val ACTION_PARAMETER_TARGET_ID = "target"

/** Adjust the state of the game, when a valid action is taken and consequence is selected. */
interface RggResultDelegate {
    fun resolve(state: RggState, board: RggBoard, parameters: RggActionParameters = mapOf())
}
